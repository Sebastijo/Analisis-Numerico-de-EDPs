...
\mu (\|\sqrt{g_1^2 + g_2^2}\|)^{1-p} (\sqrt{g_1^2 + g_2^2})^{p-2} g_1 &= 2\lambda \left( \partial_x (u - f) + \partial{xx} g_1 + \partial_{xy} g_2 \right),\\
\mu (\|\sqrt{g_1^2 + g_2^2}\|)^{1-p} (\sqrt{g_1^2 + g_2^2})^{p-2} g_2 &= 2\lambda \left( \partial_y (u - f) + \partial{xy} g_1 + \partial_{yy} g_2 \right). \end{align*}
$$
